...
{
	// printk("\n");
	// printk_color(rc_black, rc_green, "Test kmalloc() && kfree() now ...\n");

	void *addr1 = kmalloc(10);
	printk("kmalloc    10 byte in 0x%X\n", addr1);
	void *addr2 = kmalloc(100);
	printk("kmalloc   100 byte in 0x%X\n", addr2);
	// void *addr3 = kmalloc(1000);
	// printk("kmalloc  1000 byte in 0x%X\n", addr3);
	// void *addr4 = kmalloc(10000);
	// printk("kmalloc 10000 byte in 0x%X\n\n", addr4);
